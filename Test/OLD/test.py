...
class DotEnv(gym.Env):
    ...
    def reset(self, seed=0):
        ...
        observation = np.concatenate([self.blue_dot_pos, self.red_dot_pos], dtype=np.float32)


        # Optionally, return an empty reset info dictionary
        reset_info = {}
    ...
    def step(self, action):
        ...
        move_speed = 0.8 * self.game_speed
        offset = 3
        ...
        move_speed = 0.03 * self.game_speed
