...
WALLS = {
    ...
    'obstacle_walls': {
        1: {'x': SCREEN_WIDTH // 2 - 25, 'y': 0, 'width': 50, 'height': 50, 'name': 'o_w', 'gate_with': 2, 'access': 'bottom_top', 'orientation': 'horizontal'},
        2: {'x': SCREEN_WIDTH // 2 - 25, 'y': 0, 'width': 50, 'height': 50, 'name': 'o_w', 'gate_with': 1},
        3: {'x': SCREEN_WIDTH // 2 - 25, 'y': 0, 'width': 50, 'height': 50, 'name': 'o_w', 'gate_with': 4},
        4: {'x': SCREEN_WIDTH // 2 - 25, 'y': 0, 'width': 50, 'height': 50, 'name': 'o_w', 'gate_with': 5},
        5: {'x': SCREEN_WIDTH // 2 - 25, 'y': 0, 'width': 50, 'height': 50, 'name': 'o_w', 'gate_with': 4},
    }
